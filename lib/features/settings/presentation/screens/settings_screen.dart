                          ...
                          onTap: () {
                            ScaffoldMessenger.of(context)
                              ...
                              ..showSnackBar(
                                const SnackBar(
                                  content: Text(
                                    'Privacy policy link coming soon.',
                                  ),
                                  behavior: SnackBarBehavior.floating,
                                ),
                              );
                          ...
                          onTap: () {
                            ScaffoldMessenger.of(context)
                              ...
                              ..showSnackBar(
                                const SnackBar(
                                  content: Text(
                                    'Thanks! App store rating coming soon.',
                                  ),
                                  behavior: SnackBarBehavior.floating,
                                ),
                              );
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: const Align(
        ...
        child: Opacity(
          opacity: 0.1,
          child: Icon(Icons.settings_rounded, size: 130, color: Colors.white),
        ),
      ),
    );
  }
                      ...
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(
                            labelText:
                                _customMinutes ? 'Minutes' : 'Seconds',
                        ...
                        Align(
                          ...
                          child: TextButton(
                            ...
                            child: Text(
                              _customMinutes
                                  ? 'Enter seconds instead'
                                  : 'Enter minutes instead',
                            ),
                          ),
                        ),
                      ],
