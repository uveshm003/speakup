            ...
            return SingleChildScrollView(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text('How long will you practice?', style: theme.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w600)),
                  ...
                  const SizedBox(height: AppSpacing.lg),
                  Text('Custom', style: theme.textTheme.labelLarge?.copyWith(color: theme.colorScheme.onSurfaceVariant)),
                    ...
                    children: <Widget>[
                      ...
                      SegmentedButton<bool>(
                        segments: const <ButtonSegment<bool>>[
                          ButtonSegment<bool>(value: false, label: Text('sec')),
                          ButtonSegment<bool>(value: true, label: Text('min')),
                        ],
...
class _MiniCardPreview extends StatelessWidget {
  const _MiniCardPreview({required this.card, required this.accent});
      ...
      child: Stack(
        ...
        children: <Widget>[
          ...
          Text(
            ...
            style: GoogleFonts.plusJakartaSans(fontSize: 36, fontWeight: FontWeight.w700, color: Theme.of(context).colorScheme.onSurface),
          ),
        ],
      ),
    );
