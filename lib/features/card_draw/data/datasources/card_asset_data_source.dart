...
class CardAssetDataSource {
  ...
  Future<Either<Failure, void>> seedBuiltInDeckIfNeeded() async {
    ...
    return settingsResult.fold<Future<Either<Failure, void>>>(
      ...
      (UserSettings settings) async {
        ...
        try {
          final String raw =
              await rootBundle.loadString(AppAssets.cardsJson);
          ...
          final Set<String> existingIds =
              existing.map((TopicCardEntity e) => e.cardId).toSet();
          ...
          await _settingsRepository.saveSettings(
            settings.copyWith(
              cardsSeeded: true,
              cardsSeedVersion: _targetSeedVersion,
            ),
          );
          return const Right<Failure, void>(null);
        } catch (e, _) {
